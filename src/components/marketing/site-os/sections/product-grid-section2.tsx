                ...
                <div className="h-full flex max-lg:flex-col grid-cols-1 lg:grid-cols-2" data-cid="n2174">
                  <div className="w-[58%] h-[48.8125rem] flex p-8 flex-col max-lg:w-full max-md:h-[57.8125rem] max-lg:p-4 md:max-lg:h-[40.8125rem] 2xl:h-[49.8125rem]" data-cid="n2175">
                    <div className="h-5 flex items-center shrink-0 gap-2.5" data-cid="n2176">
                      <span className="block text-sm font-medium leading-5" data-cid="n2177">
                        Free audit
                      </span>
                      <button className="flex relative shrink-0 text-center cursor-default h-4 w-7" data-cid="n2178" data-component="button" aria-checked="false" aria-label="Free audit. Switch to paid connected." role="switch" type="button">
                    ...
                    <div className="block mt-4" data-cid="n2194">
                      <div className="w-[33.9rem] block max-md:w-[17.3125rem] md:max-lg:w-167.5" data-cid="n2195">
                        <div className="block relative h-11 w-full" data-cid="n2196">
                          <div className="h-full block absolute top-0 inset-x-0 rounded-[10px] overflow-hidden bg-background" data-cid="n2197">
                            <div className="h-full block absolute top-0 right-[32.4875rem] left-0 rounded-tr-[10px] rounded-br-[10px] bg-color-002 max-md:right-[265.5px] md:max-lg:right-[40.125rem]" data-cid="n2198" aria-hidden="true" />
                          </div>
                          <div className="grid relative items-center grid-rows-[44px] grid-cols-12 h-full" data-cid="n2199" aria-hidden="true">
                            <div className="flex justify-center" data-cid="n2200">
                              <span className="block rounded-full h-2.5 w-px" data-cid="n2201" />
                            </div>
                            <div className="flex justify-center" data-cid="n2202">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2203" />
                            </div>
                            <div className="flex justify-center" data-cid="n2204">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2205" />
                            </div>
                            <div className="flex justify-center" data-cid="n2206">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2207" />
                            </div>
                            <div className="flex justify-center" data-cid="n2208">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2209" />
                            </div>
                            <div className="flex justify-center" data-cid="n2210">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2211" />
                            </div>
                            <div className="flex justify-center" data-cid="n2212">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2213" />
                            </div>
                            <div className="flex justify-center" data-cid="n2214">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2215" />
                            </div>
                            <div className="flex justify-center" data-cid="n2216">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2217" />
                            </div>
                            <div className="flex justify-center" data-cid="n2218">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2219" />
                            </div>
                            <div className="flex justify-center" data-cid="n2220">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2221" />
                            </div>
                            <div className="flex justify-center" data-cid="n2222">
                              <span className="block rounded-full bg-color-003 h-2.5 w-px" data-cid="n2223" />
                            </div>
                            <span className="w-1.5 h-7 block absolute top-5.5 left-[1.4125rem] z-10 min-w-0 [translate:0px_-50%] pointer-events-none max-md:left-[11.5px] md:max-lg:left-7" data-cid="n2224" aria-hidden="true">
                              <span className="block rounded-full bg-surface-3 shadow-[var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-21)_0px_3px_14px_0px,var(--clr-22)_0px_6px_8px_-4px,var(--clr-3)_0px_0px_2px_0px,var(--clr-3)_0px_1px_2px_0px] [translate:calc(-100%_-_4px)] pointer-events-none h-7 w-1.5" data-cid="n2225" />
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <ul className="grid mt-8 items-start flex-1 gap-y-1.5 gap-x-6 grid-rows-[20px_40px_20px_20px_40px_20px_40px_20px_20px] font-medium [list-style-type:none] list-outside grid-cols-2 max-md:grid-rows-[20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px_20px] max-md:grid-cols-1 md:max-lg:grid-rows-[20px_20px_20px_20px_20px_20px_20px_20px_20px] 2xl:gap-y-2" data-cid="n2228" role="list">
